    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <div
            class="collapse-title !py-0 px-4 flex items-center cursor-pointer hover:bg-gray-100 dark:hover:bg-[#393939]"
          >
            <Icon
              v-if="item?.icon?.icon"
              :icon="item?.icon?.icon"
        ...
        <RouterLink
          ...
          :to="item?.to"
          @click="sidebarShow = false"
          class="cursor-pointer rounded-lg px-4 flex items-center py-2 hover:bg-gray-100 dark:hover:bg-[#393939]"
        >
          <Icon
            v-if="item?.icon?.icon"
            :icon="item?.icon?.icon"
      ...
      <div class="px-2">
        ...
        <a
          href="https://twitter.com/validotgo"
          target="_blank"
          class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-gray-100 dark:hover:bg-[#393939]"
        >
